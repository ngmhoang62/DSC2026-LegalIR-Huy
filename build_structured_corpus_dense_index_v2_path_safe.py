...
def structure_chunks(doc_id: str, text: str, cap: int, parse_document_into_sections):
...
def main():
    ...
    try:
        for i, d in enumerate(remaining, 1):
            chunks, audit = structure_chunks(d, docs[d], args.cap, parse_document_into_sections)
