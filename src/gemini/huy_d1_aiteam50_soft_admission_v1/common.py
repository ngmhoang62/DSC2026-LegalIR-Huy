"""Common utilities, data loaders, exact D1 baseline, and provenance checks.
...
SRC_DIR = ROOT / "src/gemini/huy_d1_aiteam50_soft_admission_v1"
RESULTS_DIR = ROOT / "results/gemini/huy_d1_aiteam50_soft_admission_v1"

# AITeam Full-Corpus Top-50 & Report
AITEAM_TOP50_PATH = ROOT / "results/sol_high_rl/AITEAM_FT_FULL_CORPUS_TOP50.json"
EXPECTED_AITEAM_TOP50_SHA256 = "458c2df064cc52123d285069c0b1df9c8c48371e7cb161870b060b3c25defe3f"
AITEAM_REPORT_PATH = ROOT / "results/sol_high_rl/AITEAM_FT_FULL_CORPUS_REPORT.json"
EXPECTED_AITEAM_REPORT_SHA256 = "0c44755c6d12a4e29f0f5d30e770f041e1b51af1b83f170ad1b59a152b6b9b5e"

# 5-Fold Stratified Split
CAL600_5FOLD_PATH = ROOT / "results/sol_high_rl/CAL600_STRATIFIED_5FOLD_SEED42.json"
EXPECTED_5FOLD_SHA256 = "c6010d4ee8ff9e7d05ec6f17245c107819a5fecf7cfbeae11b241ad1be3f47f3"

# Expert Models and Evidence Caches
JINA_FT_CV_PATH = ROOT / "results/from_drive/jina_ft_cv.pkl"
EXPECTED_JINA_FT_CV_SHA256 = "666296dc0bffdf7366c2b5834aed1612bb34ffc45bbd2696b227338367282d00"
...
EXPECTED_SECTION_CE_SHA256 = "94daae7c1273d6f1615912b8d52b64a194620bf08c6f26d7f220495bfeadb0c7"
...
def load_cal_data_label_free():
    ...
    vnlegal_cv = load_pkl("results/embedding_finetunc/vnlegal_lal_cv_scores.pkl") if (ROOT / "results/embedding_finetunc/vnlegal_lal_cv_scores.pkl").exists() else load_pkl("results/embedding_finetune/vnlegal_lal_cv_scores.pkl")
...
def compute_d1_lobo(
    ...
    """Compute exact D1 LOBO rankings and decision scores across 4 blocks."""
...
def verify_d1_parity(
    ...
    parity_doc = {
        "schema_version": "dsc2026.gemini.huy_d1_aiteam50_soft_admission_v1.d1_parity.v1",
    ...
    out_path = RESULTS_DIR / "D1_PARITY.json"
    RESULTS_DIR.mkdir(parents=True, exist_ok=True)
    out_path.write_text(json.dumps(parity_doc, indent=2), encoding="utf-8")
    return parity_doc
