"""Common paths, constants, loaders, and provenance for HUY_D1_AITEAM_NOVEL_CONSENSUS_V1."""
...
SRC_DIR = ROOT / "src/gemini/huy_d1_aiteam_novel_consensus_v1"
RESULTS_DIR = ROOT / "results/gemini/huy_d1_aiteam_novel_consensus_v1"
...
def evaluate_parity(
    ...
    parity_doc = {
        "schema_version": "dsc2026.gemini.huy_d1_aiteam_novel_consensus_v1.d1_parity.v1",
