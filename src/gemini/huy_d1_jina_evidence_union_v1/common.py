"""Common utilities, data loaders, and model definitions for HUY_D1_JINA_EVIDENCE_UNION_V1."""
...
RES_DIR = ROOT / "results/gemini/huy_d1_jina_evidence_union_v1"
SRC_DIR = ROOT / "src/gemini/huy_d1_jina_evidence_union_v1"
...
EXPECTED_CHECKPOINT_SHA256 = "45fe9a9715542dc541ca264de2f26f5cf66a642d98cd51737a25767f6deaab26"
...
EVIDENCE_UNION_CACHE_PKL = RES_DIR / "jina_ft_evidence_union_cv.pkl"
...
def top_passages(question: str, text: str, count: int = 2, window: int = 220, overlap: int = 70) -> List[str]:
    """Historical cheap lexical preselection; return original-Unicode windows for Jina."""
