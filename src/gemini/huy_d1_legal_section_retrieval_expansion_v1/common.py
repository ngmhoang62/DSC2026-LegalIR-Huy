"""Common utilities, data loaders, and path definitions for HUY_D1_LEGAL_SECTION_RETRIEVAL_EXPANSION_V1."""
...
RES_DIR = ROOT / "results/gemini/huy_d1_legal_section_retrieval_expansion_v1"
SRC_DIR = ROOT / "src/gemini/huy_d1_legal_section_retrieval_expansion_v1"
...
EXPECTED_CAL_BASE_CANDIDATE_RECALL = 0.9847222222222222

# Canonical V2 Paths (Proven in STRICT_V2_PROVENANCE_AUDIT.json)
...
EXPECTED_V2_BASE_CANDIDATE_RECALL = 0.9819315310160684

# Complementarity Path
CAL_LEGAL_REF_ADDITIONS_JSONL = ROOT / "results/gemini/huy_d1_query_anchored_legal_ref_expansion_v1/CAL_PER_QUERY_EXPANSION.jsonl"
