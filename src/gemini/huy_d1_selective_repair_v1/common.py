"""Common utilities, data loaders, reference parsers, and provenance for HUY_D1_SELECTIVE_REPAIR_V1."""
...
SRC_DIR = ROOT / "src/gemini/huy_d1_selective_repair_v1"
RESULTS_DIR = ROOT / "results/gemini/huy_d1_selective_repair_v1"

# Frozen score caches
CAL_FROZEN_SECTION_CACHE_PATH = ROOT / "results/gemini/huy_d1_legal_section_evidence_v1/legal_section_ce_cv.pkl"
OLD_JINA_CACHE_PATH = ROOT / "results/from_drive/jina_ft_cv.pkl"
...
EXPECTED_OLD_JINA_SHA256 = "666296dc0bffdf7366c2b5834aed1612bb34ffc45bbd2696b227338367282d00"
EXPECTED_SECTION_CE_SHA256 = "94daae7c1273d6f1615912b8d52b64a194620bf08c6f26d7f220495bfeadb0c7"

BOOTSTRAP_REPLICAS = 51
BOOTSTRAP_THRESHOLD = 33
SEED = 2026
...
# --- Legal Reference Canonicalization & Extraction ---
...
def extract_query_references(query_text: str) -> List[str]:
    ...
    for m in raw_matches:
        # Exclude pure date matches e.g. 02/9/2020 or 1/1/2021
